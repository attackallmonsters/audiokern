...
public:
     ...
     */
    const std::string getInputBusName(size_t index);
...
private:
    ...
    std::vector<std::string> busNames;      // Names of the registered input busses
    std::vector<DSPAudioBus *> busses;      // Pointers to the actual input buffers
